...
import {
  ...
  EM_KNOT_CONSTRUCTOR_KNOT_MULTIPLICITY,
  EM_KNOT_DECREMENT_KNOT_MULTIPLICITY,
  EM_KNOT_INCREMENT_DECREMENT,
  EM_KNOT_INDEX_VALUE,
  Knot,
  KnotIndexIncreasingSequence,
  KnotIndexStrictlyIncreasingSequence,
} from "../src/Knot";
...
describe("Knots", () => {
  describe("Knot constructor", () => {
    it("cannot be initialized with a multiplicity value smaller than one", () => {
      ...
      expect(() => new Knot(abscissa, multiplicity)).to.throw(
        EM_KNOT_CONSTRUCTOR_KNOT_MULTIPLICITY
      );
    });
  ...
  describe("Accessors", () => {
    it("cannot set a knot abscissa value to the default value", () => {
      ...
      const multiplicity = 1;
      const knot = new Knot(abscissa, multiplicity);
      expect(() => (knot.abscissa = DEFAULT_KNOT_ABSCISSA_VALUE)).to.throw(
        EM_KNOT_CONSTRUCTOR_KNOT_ABSCISSA
      );
    });
    ...
    it("cannot set a knot multiplicity value smaller than one", () => {
      ...
      const multiplicity = 1;
      const knot = new Knot(abscissa, multiplicity);
      expect(() => (knot.multiplicity = 0)).to.throw(
        EM_KNOT_CONSTRUCTOR_KNOT_MULTIPLICITY
      );
    });
  ...
  describe("Methods", () => {
    ...
    it("cannot increment the knot multiplicity with a value smaller than one", () => {
      ...
      const multiplicity = 1;
      const knot = new Knot(abscissa, multiplicity);
      expect(() => knot.incrementMultiplicity(0)).to.throw(
        EM_KNOT_INCREMENT_DECREMENT
      );
    });
    ...
    it("cannot decrement the multiplicity of a knot if its multiplicity becomes smaller than one", () => {
      ...
      const multiplicity = 1;
      const knot = new Knot(abscissa, multiplicity);
      expect(() => knot.decrementMultiplicity()).to.throw(
        EM_KNOT_DECREMENT_KNOT_MULTIPLICITY
      );
    });
    ...
    it("cannot decrement the knot multiplicity with a value smaller than one", () => {
      ...
      const multiplicity = 1;
      const knot = new Knot(abscissa, multiplicity);
      expect(() => knot.decrementMultiplicity(0)).to.throw(
        EM_KNOT_INCREMENT_DECREMENT
      );
    });
  });
...
describe("KnotIndexStrictlyIncreasingSequence", () => {
  describe("KnotIndexStrictlyIncreasingSequence constructor", () => {
    it("cannot be initialized with a negative value", () => {
      const index = -1;
      expect(() => new KnotIndexStrictlyIncreasingSequence(index)).to.throw(
        EM_KNOT_INDEX_VALUE
      );
    });
...
describe("KnotIndexIncreasingSequence", () => {
  describe("KnotIndexIncreasingSequence constructor", () => {
    it("cannot be initialized with a negative value", () => {
      const index = -1;
      expect(() => new KnotIndexIncreasingSequence(index)).to.throw(
        EM_KNOT_INDEX_VALUE
      );
    });
